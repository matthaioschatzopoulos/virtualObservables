...
nele = 6
Nx_samp = 5 # 5 is good
Nx_samp_phiOpt = 10 # Checked manually and 100 seem ok
...
### Phi Optimization ###
lr = 0.0001  ### In the PolynomialMultivariate case reducing the learning rate can have a positive effect
gradLr = 0.005 ### It is probably good to be the same as the SVI lr for stability reasons
Iter_grad = 25 #Epochs number for phiGradOpt method
eigRelax = None
